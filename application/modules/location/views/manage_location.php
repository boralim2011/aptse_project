...
<!--                                <option value="1000" --><?php //echo $display_count==1000? 'selected="selected"':''; ?><!-->1000</option>-->
<!--                                <option value="2000" --><?php //echo $display_count==2000? 'selected="selected"':''; ?><!-->2000</option>-->
                            </select>
                        </div>
                        <div class="col-xs-8">
