                            ...
                            <div class="row">
                                <div class="form-group ccol-lg-6 col-sm-6 col-xs-12">
                                    <select id="search_by" name="search_by" class="form-control select2" data-placeholder="Search By"  style="width: 100%;">
                                        <option value="contact_name" <?php echo isset($search_by) && $search_by=="contact_name" ? 'selected="selected"':'';?> >Company Name</option>
                                        <option value="contact_name_kh" <?php echo isset($search_by) && $search_by=="contact_name_kh" ? 'selected="selected"':'';?> >Company Name KH</option>
                        ...
                        <?php if(isset($companies) && is_array($companies)){
                            foreach($companies as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#company/edit/<?php echo $row->contact_id;?>" data-json='{"contact_id":<?php echo $row->contact_id;?>}' class="inline-button" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil text-orange"></i> </a>
                                        <a href="#" data-json='{"contact_id":<?php echo $row->contact_id;?>}' class="inline-button btn-delete" data-toggle="tooltip" title="Delete" url="<?php echo base_url();?>company/delete"> <i class="fa fa-trash-o text-red"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            }
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function post_search( page=1)
        {
            ...
            var url = "<?php echo base_url()?>company/manage_company";
