        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-xs-12" style="margin-top: 3px;" >
                            <a href="#employer/add" class="btn btn-primary" ><i class="fa fa-plus"></i> Add</a>
                            <a href="#employer" class="btn btn-primary btn-refresh"><i class="fa fa-refresh"></i> Refresh</a>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-xs-12" style="margin-top: 3px;">
                            <div class="row">
                                <div class="form-group ccol-lg-6 col-sm-6 col-xs-12">
                                    <select id="search_by" name="search_by" class="form-control select2" data-placeholder="Search By"  style="width: 100%;">
                                        <option value="contact_name" <?php echo isset($search_by) && $search_by=="contact_name" ? 'selected="selected"':'';?> >Employer Name</option>
                                        <option value="contact_name_kh" <?php echo isset($search_by) && $search_by=="contact_name_kh" ? 'selected="selected"':'';?> >Employer Name KH</option>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <select id="agency_type_id" name="agency_type_id" class="form-control select2" data-placeholder="Employer type"  style="width: 100%;">
                                <option value="0" <?php echo isset($agency_type_id) && $agency_type_id==0 ? 'selected="selected"':'';?> >All Employer Type</option>
                ...
                <div class="box-body" id="display-list">
                    <table id="employer-table" class="table table-bordered table-hover data-table">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th>Employer Name</th>
                        ...
                        <?php if(isset($employers) && is_array($employers)){
                            foreach($employers as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#employer/edit/<?php echo $row->contact_id;?>" data-json='{"contact_id":<?php echo $row->contact_id;?>}' class="inline-button" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil text-orange"></i> </a>
                                        <a href="#" data-json='{"contact_id":<?php echo $row->contact_id;?>}' class="inline-button btn-delete" data-toggle="tooltip" title="Delete" url="<?php echo base_url();?>employer/delete"> <i class="fa fa-trash-o text-red"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            }
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var t = $('#employer-table').DataTable( {
            "scrollX": true,
            ...
            //    var btn_delete = '<a href="#" onclick="delete_employer('+ contact_id +')" class="inline-button" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash-o text-red"></i> </a>';
            //    var btn_edit = '<a href="#" onclick="edit_employer('+contact_id+')" class="inline-button" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil text-orange"></i> </a>';
        ...
        function post_search( page=1)
        {
            ...
            var url = "<?php echo base_url()?>employer/manage_employer";
    ...
    $(document).ready(function(){
        ...
        $(document).on("click",".btn-delete", function(event){
            ...
            $(document).on("click", "#dialog-confirm #btn-ok", function(event){
                ...
                $.ajax({
                    //url: '<?php //echo base_url();?>employer_group/delete',
                    url: btn.attr("url"),
                    type: 'POST',
                    data: formData,
                    dataType:"json",
