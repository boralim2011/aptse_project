...
<table id="register-table" class="table table-striped table-bordered report">
    ...
    <tr>
        ...
        <th rowspan="2" class="date-col">Canceled</th>
    ...
    <?php if(isset($registers) && is_array($registers)){
        ...
        foreach($registers as $row){
            ...
            <tr>
                ...
                <td><?php echo isset($row->date_of_fly)? $row->canceled_date:"";?></td>
                <td><?php echo isset($row->agency_name)? $row->canceled_reason:"";?></td>
            </tr>
        <?php
        }
    }
