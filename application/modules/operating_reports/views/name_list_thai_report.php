<div class="report">
    ...
    <table width="100%">
        <tr>
            <td> </td>
            <td style="font-family:'Khmer OS System'; font-size: 12px; text-align: center; width: 360px;" >​ ធ្វើនៅរាជធានីភ្នំពេញ ថ្ងៃទី​  <span style="display: inline-block; width: 40px;"></span> ខែ <span style="display: inline-block; width: 50px;"></span> ឆ្នាំ  <span style="display: inline-block; width: 40px;"><?php //echo Date("Y");?> </td>
        </tr>
        <tr>
            <td></td>
