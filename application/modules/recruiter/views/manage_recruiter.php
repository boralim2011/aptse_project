                            ...
                            <div class="row">
                                <div class="form-group ccol-lg-6 col-sm-6 col-xs-12">
                                    <select id="search_by" name="search_by" class="form-control select2" data-placeholder="Search By"  style="width: 100%;">
                                        <option value="contact_name" <?php echo isset($search_by) && $search_by=="contact_name" ? 'selected="selected"':'';?> >Recruiter Name</option>
                                        <option value="contact_name_kh" <?php echo isset($search_by) && $search_by=="contact_name_kh" ? 'selected="selected"':'';?> >Recruiter Name KH</option>
                        ...
                        <?php if(isset($recruiters) && is_array($recruiters)){
                            foreach($recruiters as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#recruiter/edit/<?php echo $row->contact_id;?>" data-json='{"contact_id":<?php echo $row->contact_id;?>}' class="inline-button" data-toggle="tooltip" title="Edit"> <i class="fa fa-pencil text-orange"></i> </a>
                                        <a href="#" data-json='{"contact_id":<?php echo $row->contact_id;?>}' class="inline-button btn-delete" data-toggle="tooltip" title="Delete" url="<?php echo base_url();?>recruiter/delete"> <i class="fa fa-trash-o text-red"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            }
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function post_search( page=1)
        {
            ...
            var url = "<?php echo base_url()?>recruiter/manage_recruiter";
